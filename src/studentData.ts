...
export interface StudentCertificate {
  ...
  course: 'Programming' | 'Basic Computer' | 'DCA' | 'PGDCA' | 'Web Development' | 'Internship'; // Main Category (Inhi me se select karein)
...
export const studentsCertificates: StudentCertificate[] = [
  ...
  // ==========================================
  {
    ...
    certificateUrl: "https://images.unsplash.com/photo-1589330694653-efa6475306fa?q=80&w=800&auto=format&fit=crop",
    issueDate: "28 June 2026"
  },
  {
    id: "DC-DCA-2026-202",
    studentName: "Deepak Soni",
    course: "DCA",
  ...
  // ==========================================
  // 5. WEB DEVELOPMENT STUDENTS
  // ==========================================
  {
    id: "DC-WEB-2026-401",
    studentName: "Shweta Tiwari",
    course: "Web Development",
    profilePhoto: "https://images.unsplash.com/photo-1554151228-14d9def656e4?q=80&w=200&auto=format&fit=crop",
    certificateUrl: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=800&auto=format&fit=crop",
